...
public class Main {
  ...
  // try {
  // adjDoubleMatrix = writeMatrixToFile(size, vertexIdArray, adjMatrix, 100,
  // fileName);
  // for (int i = 0; i < size; i++) {
  // for (int j = 0; j < size; j++) {
  ...
  // Thread t1 = new Thread(new MasterThread(size, vertexIdArray,
  // adjDoubleMatrix));
  // t1.setName("thread_0");
  // t1.start();
  // } catch (Exception e) {
  ...
  // * @throws IOException
  // */
  // public static double[][] writeMatrixToFile(int size, int[] vertexIdArray,
  // int[][] adjMatrix, int max, String fileName)
  // throws IOException {
  // Random r = new Random();
  // double[][] adjDoubleMatrix = new double[size][size];
  // for (int i = 0; i < size; i++) {
